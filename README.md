...
> [!IMPORTANT]
> **Прямая работа с БД (без API):** Бот взаимодействует с панелью 2S-UI / X-UI **напрямую через локальный файл базы данных SQLite (`s-ui.db`)**, без использования HTTP API панели.  
